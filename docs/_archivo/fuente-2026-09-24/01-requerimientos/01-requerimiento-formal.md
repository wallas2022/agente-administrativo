# 01 · Requerimiento formal (SRS) – Agente de validación documental
...
- El servidor es físico: TI instala Proxmox VE y luego la infraestructura virtual. El ambiente stage no estará disponible hasta que se otorgue acceso, por lo que el desarrollo se realiza en un ambiente local y se documenta el despliegue a stage (ver `docs/03-diseno/despliegue/estrategia-ambientes.md`).
- Existe un análisis inicial y un prototipo de diseño de 3 pantallas (ver `docs/02-analisis/01-analisis-inicial.md`).
...
Detalle en `docs/01-requerimientos/02-casos-de-uso.md`.

| ID | Caso de uso | Actor principal | RF |
| --- | --- | --- | --- |
| CU-01 | Validar Excel contable | Analista | RF-03..06, 12..15 |
| CU-02 | Revisar redacción PDF/Word | Analista | RF-07, 12..14 |
| CU-03 | Verificar actualización normativa | Analista | RF-08, 12 |
| CU-04 | Evaluar control/checklist | Analista | RF-09, 12 |
| CU-05 | Revisar ortografía multi-formato | Analista | RF-10, 17, 14 |
| CU-06 | Convertir imagen a texto (OCR) | Analista | RF-11 |
| CU-07 | Aprobar o rechazar hallazgos | Revisor | RF-13, 14, 20 |
| CU-08 | Gestionar base de conocimiento | Curador | RF-16, 17 |
| CU-09 | Administrar usuarios y roles | Administrador | RF-01, 02 |
| CU-10 | Consultar auditoría | Auditor | RF-18, 19 |
...
Ver `docs/01-requerimientos/03-historias-de-usuario.md`.

## 14. Pruebas de prototipo
Ver `docs/04-pruebas/plan-pruebas-prototipo.md`.
