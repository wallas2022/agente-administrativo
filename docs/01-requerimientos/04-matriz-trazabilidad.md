...
| RF-09 | OE-03 | RG-04 | CU-04 | HU-08 | — | — | 2 |
...
5. RF-01 se reasignó a HU-01 (carga y selección de revisión) por indicación explícita al revisar esta matriz; HU-14 (autenticación, notificación y consulta de historial) sigue existiendo como historia de usuario en [03-historias-de-usuario.md](03-historias-de-usuario.md) pero ya no es la única referencia de RF-01 en esta tabla — a resolver en una futura revisión de HU-01/HU-14 para que ambos documentos queden consistentes.
