...
**Versión:** 1.2 · **Fecha:** 2026-09-24 · **Relacionado con:** RNF-01, RNF-02, RNF-07, RNF-08, RNF-14, R-10, `docs/03-diseno/despliegue/estrategia-ambientes.md`
...
## 6. Configuración
- `.env.stage` a partir de [infra/.env.stage.example](../../infra/.env.stage.example); secretos entregados por canal seguro, nunca en Git.
