...
Detalle y estructura real del dataset en [tests/dataset/README.md](../../tests/dataset/README.md).

## 2. Casos de prueba
Detalle individual de cada prueba en [docs/04-pruebas/casos-prueba/](casos-prueba/).
