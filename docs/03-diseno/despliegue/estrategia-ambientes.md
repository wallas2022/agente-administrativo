...
**Versión:** 1.2
**Fecha:** 2026-09-24
**Relacionado con:** RNF-01, RNF-02, RNF-07, RNF-10, RNF-14, R-02, R-10, [ADR-004](../adr/ADR-004-ambientes-local-stage.md)
...
Esqueleto ya declarado (inactivo por defecto): [infra/compose.gpu.yml](../../../infra/compose.gpu.yml) — servicio `vllm` bajo el perfil `gpu`, no se activa salvo `--profile gpu`.
